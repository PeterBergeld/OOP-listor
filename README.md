Facinerande hur frustrerande chat:en kan vara. Stöter på en mängder med Väggar // måste bli bättre på att prompta


## Nu så du var vi på readme

## Till chatten

äs texten och ge mig instruktioner husr jag löser uppgiften. Små hintar och när jag känner mig klar, skriver jag klar. Annars är vi på samma deluppgift , vi tar det lugnt och försiktigt. //15:50 Codex 09/10 -2026


varje gång jag skriver "vad" går du igenom min skriva kod och ger mig varför den är fel
...
else if (val == 2) // Om användaren väljer 2
{
 ...
 //samt föregående } tas bort för att den inte skulle vara där. 
